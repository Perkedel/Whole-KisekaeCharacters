...
##Love Live!, **μ's** (Muse) not *Musescore*! (This set is default setting on Pochi Kisekae app)
###Yazawa Nico
...
- Birthdate: _Japan which city_, 22 July ????
- Gender: Female
- Height: 154 cm
- Weight: ??? Kg
...
- Birthdate: _Japan which city?_, XX _Month_ XXXX
- Gender: Female
- Height: cm
- Weight: kg
- Hair: #
...
- Blood Type: 
- Creator: Sakurako Kimino
- Source: [Wikia article](http://www.example.com "Example source"); Pochi Kisekae App
- Description: (On the Wikia it says)
- _Another variables_: _anwflnsbrgsfuoalnerfjklajsd;fjaberwfbuegobadsuotgf_
- Copyright: Sakurako Kimino and _friends_, All Rights Reserved
- License: **PROPRIETARY**
